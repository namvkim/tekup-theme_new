...
<body id="homepage">
    <section class="
        ...
        px-3
      ">
        <img class="homepage__banner__img position-absolute top-0 end-0" src="<?php echo get_template_directory_uri() ?>/images/home_tekupcompanyvideo.gif" alt="" />
        <div class="homepage__banner__main">
          ...
          ">
                ...
                <img src="<?php echo get_template_directory_uri() ?>/images/home_poiter.svg" alt="" />
            </div>
            <div class="d-flex align-items-center">
                ...
                <div class="homepage__banner__logo__right position-relative">
                    <div>
                        <div class="d-flex align-items-center justify-content-center">
                            <img src="./images/homepage_google.svg" alt="" />
                        </div>
                        <div class="d-flex align-items-center justify-content-center">
    ...
    <section class="
      ...
      ">
        <div class="homepage__about__stroke__1a position-absolute start-0 top-0">
            <img src="<?php echo get_template_directory_uri() ?>/images/home_stroke_1.png" alt="" />
        </div>
        ...
        <div class="homepage__about__stroke__3 position-absolute start-0 toop-0">
            <img src="<?php echo get_template_directory_uri() ?>/images/home_stroke_3.png" alt="" />
        </div>
        <div class="homepage__about__stroke__4 position-absolute end-0 bottom-0">
            <img src="<?php echo get_template_directory_uri() ?>/images/home_stroke_4.png" alt="" />
        </div>
        <img class="homepage__about__stroke__5 position-absolute start-0" src="./images/homepage_stroke_5.png" alt="" />
        <div class="
          ...
          position-relative
        ">
            <img class="homepage__about__stroke__2 position-absolute" src="<?php echo get_template_directory_uri() ?>/images/home_stroke_2.png" />
    ...
    <section class="homepage__services__container d-flex justify-content-center px-3">
        <div class="homepage__services__content">
            ...
            <div class="d-lg-flex justify-content-between position-relative">
                <img src="<?php echo get_template_directory_uri() ?>/images/home_stroke_6.png" alt="" class="homepage__service__stroke__6 position-absolute" />
                <div class="
              homepage__services__containerTab
              flex-column
              justify-content-between
            ">
                    <div class="tablinks homepage__services__box d-flex align-items-center" onclick="openCity(event, 'homepage_service1')" id="defaultOpen">
                        <div class="homepage__services__boxImage"></div>
                        <div class="homepage__services__boxText">
                            Trí tuệ nhân tạo & Tầm nhìn máy tính
                        </div>
                    </div>
                    <div class="tablinks homepage__services__box d-flex align-items-center" onclick="openCity(event, 'homepage_service2')">
                        <div class="homepage__services__boxImage"></div>
                        <div class="homepage__services__boxText">
                            Phát triển ứng dụng di động và web
                        </div>
                    </div>
                    <div class="tablinks homepage__services__box d-flex align-items-center" onclick="openCity(event, 'homepage_service3')">
                        <div class="homepage__services__boxImage"></div>
                ...
                <div id="homepage_service1" class="homepage__services__tabcontent position-relative">
                    <img class="homepage__services__imageContentTab" src="./images/Rectangle.png" alt="" />
                ...
                align-items-center
              ">
                        <a class="homepage__services__textBtn-1" href="service.html">TÌM HIỂU THÊM</a>
                        <img src="<?php echo get_template_directory_uri() ?>/images/home_right_arrow.svg" alt="" />
                    </div>
                </div>
                <div class="homepage__services__box__mb align-items-center">
                    <img src="./images/fingerPrint.svg" alt="" />
                ...
                <div id="homepage_service2" class="homepage__services__tabcontent position-relative">
                    <img class="homepage__services__imageContentTab" src="./images/Tangle2.jpg" alt="" />
                    <div class="homepage__services__text__block">
              ...
              ">
                ...
                <div id="homepage_service3" class="homepage__services__tabcontent position-relative">
                    <img class="homepage__services__imageContentTab" src="./images/Tangle3.jpg" alt="" />
                    <div class="homepage__services__text__block">
    ...
    <section class="d-flex justify-content-center position-relative px-3">
        <img src="<?php echo get_template_directory_uri() ?>/images/home_background_dot3d.gif" alt="" class="homepage__statistics__background position-absolute" />
        ...
        <div id="swiper-container">
            <div id="gallery-top">
              ...
              " id="homepage__project__1">
                        <img src="https://wallpaperaccess.com/full/1157063.jpg" alt="" class="
                  homepage__project__background
                  position-absolute
                  top-0
                  start-0
                " />
                        <img src="<?php echo get_template_directory_uri() ?>/images/home_stroke_9.png" alt="" class="homepage__reviews__stroke__9 position-absolute start-0" />
                        <div class="homepage__project__item__content">
                            <img src="./images/homepage_image_iphone.png" alt="" class="homepage__project__item__image" />
                      ...
                      ">
                                        ...
                                        <img src="<?php echo get_template_directory_uri() ?>/images/home_right_arrow_white.svg" alt="" />
                                    </div>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="homepage___project__item tab-pane fade" id="homepage__project__2">
                        ...b
                    </div>
                    <div class="homepage___project__item tab-pane fade" id="homepage__project__3">
                        ...c
                    </div>
                    <div class="homepage___project__item tab-pane fade" id="homepage__project__4">
                        ...d
                    </div>
                </div>
            </div>
            <div class="homepage___project__tablist__container">
                <div class="nav homepage___project__tablist" id="nav-tab" role="tablist">
                    <div data-bs-toggle="tab" data-bs-target="#homepage__project__1" class="homepage___project__tab">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRukxV1c4mElW_dzBd0am0iXo-SmrmubWAg-vxr21LDkd4Se35gSwHFfPROv5-iTeSKerQ&usqp=CAU" alt="" class="homepage___project__tab__img" />
                    ...
                    <div data-bs-toggle="tab" data-bs-target="#homepage__project__2" class="homepage___project__tab">
                        <img src="./images/Rectangle.png" alt="" class="homepage___project__tab__img" />
                        <div class="homepage___project__tab__title">AI Plan Chedule</div>
                        <div class="homepage___project__tab__sub mt-2">UI/UX Design</div>
                    </div>
                    <div data-bs-toggle="tab" data-bs-target="#homepage__project__3" class="homepage___project__tab">
                        <img src="./images/Rectangle.png" alt="" class="homepage___project__tab__img" />
                        <div class="homepage___project__tab__title">AI Plan Chedule</div>
                        <div class="homepage___project__tab__sub mt-2">UI/UX Design</div>
                    </div>
                    <div data-bs-toggle="tab" data-bs-target="#homepage__project__4" class="homepage___project__tab">
                        <img src="./images/Rectangle.png" alt="" class="homepage___project__tab__img" />
                        <div class="homepage___project__tab__title">AI Plan Chedule</div>
                        <div class="homepage___project__tab__sub mt-2">UI/UX Design</div>
                    </div>
    ...
    <section class="
        ...
        position-relative
      ">
        <img src="<?php echo get_template_directory_uri() ?>/images/home_stroke_7.png" alt="" class="homepage__reviews__stroke__7 position-absolute top-0 start-0" />
        <div class="homepage__reviews__content d-flex">
            <img src="<?php echo get_template_directory_uri() ?>/images/home_stroke_8.png" alt="" class="homepage__reviews__stroke__8 position-absolute" />
            <div class="homepage__reviews__image position-relative">
                <img src="<?php echo get_template_directory_uri() ?>/images/home_customer_reviews_1.png" alt="" class="homepage__reviews__image__1" />
                <img src="<?php echo get_template_directory_uri() ?>/images/home_customer_reviews_2.png" alt="" class="homepage__reviews__image__2" />
                <img src="<?php echo get_template_directory_uri() ?>/images/home_customer_reviews_3.png" alt="" class="homepage__reviews__image__3" />
                <img src="<?php echo get_template_directory_uri() ?>/images/home_customer_reviews_4.png" alt="" class="homepage__reviews__image__4" />
                <img src="<?php echo get_template_directory_uri() ?>/images/home_customer_reviews_5.png" alt="" class="homepage__reviews__image__5" />
            </div>
            <div class="homepage__reviews__slide__box">
                <div class="homepage__reviews__slide">
                  ...
                  justify-content-center
                ">
                            <img src="<?php echo get_template_directory_uri() ?>/images/home_customer_reviews_6.png" alt="" />
                            <div class="ms-3">
                        ...
                        <div class="homepage__reviews__star d-flex mb-4">
                            <img src="<?php echo get_template_directory_uri() ?>/images/home_icon_star.svg" alt="" />
                            <img src="<?php echo get_template_directory_uri() ?>/images/home_icon_star.svg" alt="" />
                            <img src="<?php echo get_template_directory_uri() ?>/images/home_icon_star.svg" alt="" />
                            <img src="<?php echo get_template_directory_uri() ?>/images/home_icon_star.svg" alt="" />
                            <img src="<?php echo get_template_directory_uri() ?>/images/home_icon_star.svg" alt="" />
                  ...
                  justify-content-center
                ">
                            <img src="<?php echo get_template_directory_uri() ?>/images/home_customer_reviews_1.png" alt="" />
                            <div class="ms-3">
                  ...
                  justify-content-center
                ">
                            <img src="<?php echo get_template_directory_uri() ?>/images/home_customer_reviews_2.png" alt="" />
                            <div class="ms-3">
    ...
    <section class="homepage__contact__container d-flex justify-content-center px-3 position-relative">
        <img class="homepage__contact__img position-absolute" src="<?php echo get_template_directory_uri() ?>/images/home_background_img.png" alt="">
        <div class="homepage__contact__content d-flex flex-column align-items-center">
            ...
            <div class="home__contact__button">
                <a href="contact.html" class="d-flex align-items-center">
                    ...
                    <img class="" src="<?php echo get_template_directory_uri() ?>/images/menu_poiter.svg" />
                </a>
            </div>
        </div>
    </section>
